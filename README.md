...
- **Shop Shuffle** — every vendor sells from the whole item list on all three tabs: weapons, armor, gems, runes, jewels, charms, rings and amulets, as normal, magic, rare, set and unique items at the game's own prices. The shelf re-rolls when the vendor restocks, and what you buy counts for the Collection book.
- **Monster Shuffle**, **Super-Unique Shuffle**, **Entrance Shuffle** (all optional).
