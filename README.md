...
- **Waypoint list empty after save & exit (Act 2):** this is a bug in vanilla Diablo II 1.10 itself, not the mod. If your waypoint list comes up empty, talk to **Jerhyn** (standing outside the palace in Lut Gholein) and the waypoints reappear.
